...
var seaweedfs_weed_pb_volume_server_pb = require('../../../seaweedfs/weed/pb/volume_server_pb.js');

function serialize_volume_server_pb_AllocateVolumeRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.AllocateVolumeRequest)) {
...
function deserialize_volume_server_pb_AllocateVolumeRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.AllocateVolumeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_AllocateVolumeResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.AllocateVolumeResponse)) {
...
function deserialize_volume_server_pb_AllocateVolumeResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.AllocateVolumeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_BatchDeleteRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.BatchDeleteRequest)) {
...
function deserialize_volume_server_pb_BatchDeleteRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.BatchDeleteRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_BatchDeleteResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.BatchDeleteResponse)) {
...
function deserialize_volume_server_pb_BatchDeleteResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.BatchDeleteResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_CopyFileRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.CopyFileRequest)) {
...
function deserialize_volume_server_pb_CopyFileRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.CopyFileRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_CopyFileResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.CopyFileResponse)) {
...
function deserialize_volume_server_pb_CopyFileResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.CopyFileResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_DeleteCollectionRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.DeleteCollectionRequest)) {
...
function deserialize_volume_server_pb_DeleteCollectionRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.DeleteCollectionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_DeleteCollectionResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.DeleteCollectionResponse)) {
...
function deserialize_volume_server_pb_DeleteCollectionResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.DeleteCollectionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_FileGetRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.FileGetRequest)) {
...
function deserialize_volume_server_pb_FileGetRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.FileGetRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_FileGetResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.FileGetResponse)) {
...
function deserialize_volume_server_pb_FileGetResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.FileGetResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_QueriedStripe(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.QueriedStripe)) {
...
function deserialize_volume_server_pb_QueriedStripe(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.QueriedStripe.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_QueryRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.QueryRequest)) {
...
function deserialize_volume_server_pb_QueryRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.QueryRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_ReadVolumeFileStatusRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.ReadVolumeFileStatusRequest)) {
...
function deserialize_volume_server_pb_ReadVolumeFileStatusRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.ReadVolumeFileStatusRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_ReadVolumeFileStatusResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.ReadVolumeFileStatusResponse)) {
...
function deserialize_volume_server_pb_ReadVolumeFileStatusResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.ReadVolumeFileStatusResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VacuumVolumeCheckRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCheckRequest)) {
...
function deserialize_volume_server_pb_VacuumVolumeCheckRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCheckRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VacuumVolumeCheckResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCheckResponse)) {
...
function deserialize_volume_server_pb_VacuumVolumeCheckResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCheckResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VacuumVolumeCleanupRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCleanupRequest)) {
...
function deserialize_volume_server_pb_VacuumVolumeCleanupRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCleanupRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VacuumVolumeCleanupResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCleanupResponse)) {
...
function deserialize_volume_server_pb_VacuumVolumeCleanupResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCleanupResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VacuumVolumeCommitRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCommitRequest)) {
...
function deserialize_volume_server_pb_VacuumVolumeCommitRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCommitRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VacuumVolumeCommitResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCommitResponse)) {
...
function deserialize_volume_server_pb_VacuumVolumeCommitResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCommitResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VacuumVolumeCompactRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCompactRequest)) {
...
function deserialize_volume_server_pb_VacuumVolumeCompactRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCompactRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VacuumVolumeCompactResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCompactResponse)) {
...
function deserialize_volume_server_pb_VacuumVolumeCompactResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCompactResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeConfigureRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeConfigureRequest)) {
...
function deserialize_volume_server_pb_VolumeConfigureRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeConfigureRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeConfigureResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeConfigureResponse)) {
...
function deserialize_volume_server_pb_VolumeConfigureResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeConfigureResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeCopyRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeCopyRequest)) {
...
function deserialize_volume_server_pb_VolumeCopyRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeCopyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeCopyResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeCopyResponse)) {
...
function deserialize_volume_server_pb_VolumeCopyResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeCopyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeDeleteRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeDeleteRequest)) {
...
function deserialize_volume_server_pb_VolumeDeleteRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeDeleteRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeDeleteResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeDeleteResponse)) {
...
function deserialize_volume_server_pb_VolumeDeleteResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeDeleteResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcBlobDeleteRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcBlobDeleteRequest)) {
...
function deserialize_volume_server_pb_VolumeEcBlobDeleteRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcBlobDeleteRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcBlobDeleteResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcBlobDeleteResponse)) {
...
function deserialize_volume_server_pb_VolumeEcBlobDeleteResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcBlobDeleteResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardReadRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardReadRequest)) {
...
function deserialize_volume_server_pb_VolumeEcShardReadRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardReadRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardReadResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardReadResponse)) {
...
function deserialize_volume_server_pb_VolumeEcShardReadResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardReadResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsCopyRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsCopyRequest)) {
...
function deserialize_volume_server_pb_VolumeEcShardsCopyRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsCopyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsCopyResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsCopyResponse)) {
...
function deserialize_volume_server_pb_VolumeEcShardsCopyResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsCopyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsDeleteRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsDeleteRequest)) {
...
function deserialize_volume_server_pb_VolumeEcShardsDeleteRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsDeleteRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsDeleteResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsDeleteResponse)) {
...
function deserialize_volume_server_pb_VolumeEcShardsDeleteResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsDeleteResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsGenerateRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsGenerateRequest)) {
...
function deserialize_volume_server_pb_VolumeEcShardsGenerateRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsGenerateRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsGenerateResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsGenerateResponse)) {
...
function deserialize_volume_server_pb_VolumeEcShardsGenerateResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsGenerateResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsMountRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsMountRequest)) {
...
function deserialize_volume_server_pb_VolumeEcShardsMountRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsMountRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsMountResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsMountResponse)) {
...
function deserialize_volume_server_pb_VolumeEcShardsMountResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsMountResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsRebuildRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsRebuildRequest)) {
...
function deserialize_volume_server_pb_VolumeEcShardsRebuildRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsRebuildRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsRebuildResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsRebuildResponse)) {
...
function deserialize_volume_server_pb_VolumeEcShardsRebuildResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsRebuildResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsToVolumeRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsToVolumeRequest)) {
...
function deserialize_volume_server_pb_VolumeEcShardsToVolumeRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsToVolumeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsToVolumeResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsToVolumeResponse)) {
...
function deserialize_volume_server_pb_VolumeEcShardsToVolumeResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsToVolumeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsUnmountRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsUnmountRequest)) {
...
function deserialize_volume_server_pb_VolumeEcShardsUnmountRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsUnmountRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeEcShardsUnmountResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsUnmountResponse)) {
...
function deserialize_volume_server_pb_VolumeEcShardsUnmountResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsUnmountResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeIncrementalCopyRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeIncrementalCopyRequest)) {
...
function deserialize_volume_server_pb_VolumeIncrementalCopyRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeIncrementalCopyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeIncrementalCopyResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeIncrementalCopyResponse)) {
...
function deserialize_volume_server_pb_VolumeIncrementalCopyResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeIncrementalCopyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeMarkReadonlyRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeMarkReadonlyRequest)) {
...
function deserialize_volume_server_pb_VolumeMarkReadonlyRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeMarkReadonlyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeMarkReadonlyResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeMarkReadonlyResponse)) {
...
function deserialize_volume_server_pb_VolumeMarkReadonlyResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeMarkReadonlyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeMountRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeMountRequest)) {
...
function deserialize_volume_server_pb_VolumeMountRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeMountRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeMountResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeMountResponse)) {
...
function deserialize_volume_server_pb_VolumeMountResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeMountResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeServerStatusRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeServerStatusRequest)) {
...
function deserialize_volume_server_pb_VolumeServerStatusRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeServerStatusRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeServerStatusResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeServerStatusResponse)) {
...
function deserialize_volume_server_pb_VolumeServerStatusResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeServerStatusResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeSyncStatusRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeSyncStatusRequest)) {
...
function deserialize_volume_server_pb_VolumeSyncStatusRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeSyncStatusRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeSyncStatusResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeSyncStatusResponse)) {
...
function deserialize_volume_server_pb_VolumeSyncStatusResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeSyncStatusResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeTailReceiverRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeTailReceiverRequest)) {
...
function deserialize_volume_server_pb_VolumeTailReceiverRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeTailReceiverRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeTailReceiverResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeTailReceiverResponse)) {
...
function deserialize_volume_server_pb_VolumeTailReceiverResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeTailReceiverResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeTailSenderRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeTailSenderRequest)) {
...
function deserialize_volume_server_pb_VolumeTailSenderRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeTailSenderRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeTailSenderResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeTailSenderResponse)) {
...
function deserialize_volume_server_pb_VolumeTailSenderResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeTailSenderResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeTierMoveDatFromRemoteRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatFromRemoteRequest)) {
...
function deserialize_volume_server_pb_VolumeTierMoveDatFromRemoteRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatFromRemoteRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeTierMoveDatFromRemoteResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatFromRemoteResponse)) {
...
function deserialize_volume_server_pb_VolumeTierMoveDatFromRemoteResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatFromRemoteResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeTierMoveDatToRemoteRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatToRemoteRequest)) {
...
function deserialize_volume_server_pb_VolumeTierMoveDatToRemoteRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatToRemoteRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeTierMoveDatToRemoteResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatToRemoteResponse)) {
...
function deserialize_volume_server_pb_VolumeTierMoveDatToRemoteResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatToRemoteResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeUnmountRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeUnmountRequest)) {
...
function deserialize_volume_server_pb_VolumeUnmountRequest(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeUnmountRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_volume_server_pb_VolumeUnmountResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_volume_server_pb.VolumeUnmountResponse)) {
...
function deserialize_volume_server_pb_VolumeUnmountResponse(buffer_arg) {
  return seaweedfs_weed_pb_volume_server_pb.VolumeUnmountResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
batchDelete: {
    ...
    requestType: seaweedfs_weed_pb_volume_server_pb.BatchDeleteRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.BatchDeleteResponse,
  ...
  fileGet: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: seaweedfs_weed_pb_volume_server_pb.FileGetRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.FileGetResponse,
  ...
  vacuumVolumeCheck: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCheckRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCheckResponse,
  ...
  vacuumVolumeCompact: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCompactRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCompactResponse,
  ...
  vacuumVolumeCommit: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCommitRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCommitResponse,
  ...
  vacuumVolumeCleanup: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCleanupRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VacuumVolumeCleanupResponse,
  ...
  deleteCollection: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.DeleteCollectionRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.DeleteCollectionResponse,
  ...
  allocateVolume: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.AllocateVolumeRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.AllocateVolumeResponse,
  ...
  volumeSyncStatus: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeSyncStatusRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeSyncStatusResponse,
  ...
  volumeIncrementalCopy: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeIncrementalCopyRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeIncrementalCopyResponse,
  ...
  volumeMount: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeMountRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeMountResponse,
  ...
  volumeUnmount: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeUnmountRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeUnmountResponse,
  ...
  volumeDelete: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeDeleteRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeDeleteResponse,
  ...
  volumeMarkReadonly: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeMarkReadonlyRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeMarkReadonlyResponse,
  ...
  volumeConfigure: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeConfigureRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeConfigureResponse,
...
volumeCopy: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeCopyRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeCopyResponse,
  ...
  readVolumeFileStatus: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.ReadVolumeFileStatusRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.ReadVolumeFileStatusResponse,
  ...
  copyFile: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: seaweedfs_weed_pb_volume_server_pb.CopyFileRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.CopyFileResponse,
  ...
  volumeTailSender: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeTailSenderRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeTailSenderResponse,
  ...
  volumeTailReceiver: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeTailReceiverRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeTailReceiverResponse,
...
volumeEcShardsGenerate: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsGenerateRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsGenerateResponse,
  ...
  volumeEcShardsRebuild: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsRebuildRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsRebuildResponse,
  ...
  volumeEcShardsCopy: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsCopyRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsCopyResponse,
  ...
  volumeEcShardsDelete: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsDeleteRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsDeleteResponse,
  ...
  volumeEcShardsMount: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsMountRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsMountResponse,
  ...
  volumeEcShardsUnmount: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsUnmountRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsUnmountResponse,
  ...
  volumeEcShardRead: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardReadRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardReadResponse,
  ...
  volumeEcBlobDelete: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeEcBlobDeleteRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeEcBlobDeleteResponse,
  ...
  volumeEcShardsToVolume: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsToVolumeRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeEcShardsToVolumeResponse,
...
volumeTierMoveDatToRemote: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatToRemoteRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatToRemoteResponse,
  ...
  volumeTierMoveDatFromRemote: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatFromRemoteRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeTierMoveDatFromRemoteResponse,
  ...
  volumeServerStatus: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_volume_server_pb.VolumeServerStatusRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.VolumeServerStatusResponse,
...
query: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: seaweedfs_weed_pb_volume_server_pb.QueryRequest,
    responseType: seaweedfs_weed_pb_volume_server_pb.QueriedStripe,
