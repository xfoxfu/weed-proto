...
var seaweedfs_weed_pb_queue_pb = require('../../../seaweedfs/weed/pb/queue_pb.js');

function serialize_queue_pb_ConfigureTopicRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_queue_pb.ConfigureTopicRequest)) {
...
function deserialize_queue_pb_ConfigureTopicRequest(buffer_arg) {
  return seaweedfs_weed_pb_queue_pb.ConfigureTopicRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_queue_pb_ConfigureTopicResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_queue_pb.ConfigureTopicResponse)) {
...
function deserialize_queue_pb_ConfigureTopicResponse(buffer_arg) {
  return seaweedfs_weed_pb_queue_pb.ConfigureTopicResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_queue_pb_DeleteTopicRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_queue_pb.DeleteTopicRequest)) {
...
function deserialize_queue_pb_DeleteTopicRequest(buffer_arg) {
  return seaweedfs_weed_pb_queue_pb.DeleteTopicRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_queue_pb_DeleteTopicResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_queue_pb.DeleteTopicResponse)) {
...
function deserialize_queue_pb_DeleteTopicResponse(buffer_arg) {
  return seaweedfs_weed_pb_queue_pb.DeleteTopicResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_queue_pb_ReadMessageRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_queue_pb.ReadMessageRequest)) {
...
function deserialize_queue_pb_ReadMessageRequest(buffer_arg) {
  return seaweedfs_weed_pb_queue_pb.ReadMessageRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_queue_pb_ReadMessageResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_queue_pb.ReadMessageResponse)) {
...
function deserialize_queue_pb_ReadMessageResponse(buffer_arg) {
  return seaweedfs_weed_pb_queue_pb.ReadMessageResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_queue_pb_WriteMessageRequest(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_queue_pb.WriteMessageRequest)) {
...
function deserialize_queue_pb_WriteMessageRequest(buffer_arg) {
  return seaweedfs_weed_pb_queue_pb.WriteMessageRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_queue_pb_WriteMessageResponse(arg) {
  if (!(arg instanceof seaweedfs_weed_pb_queue_pb.WriteMessageResponse)) {
...
function deserialize_queue_pb_WriteMessageResponse(buffer_arg) {
  return seaweedfs_weed_pb_queue_pb.WriteMessageResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var SeaweedQueueService = exports.SeaweedQueueService = {
  streamWrite: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: seaweedfs_weed_pb_queue_pb.WriteMessageRequest,
    responseType: seaweedfs_weed_pb_queue_pb.WriteMessageResponse,
  ...
  streamRead: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: seaweedfs_weed_pb_queue_pb.ReadMessageRequest,
    responseType: seaweedfs_weed_pb_queue_pb.ReadMessageResponse,
  ...
  configureTopic: {
    ...
    requestType: seaweedfs_weed_pb_queue_pb.ConfigureTopicRequest,
    responseType: seaweedfs_weed_pb_queue_pb.ConfigureTopicResponse,
  ...
  deleteTopic: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: seaweedfs_weed_pb_queue_pb.DeleteTopicRequest,
    responseType: seaweedfs_weed_pb_queue_pb.DeleteTopicResponse,
